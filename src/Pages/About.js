  ...
  return (
    <main className="container mx-auto max-width pt-10 pb-20 ">
      <section>
        ...
        <h3 className="text-2xl font-bold text-content py-8 lg:max-w-3xl">Software Developer | Product Designer</h3>
        <p className="text-content py-1 lg:max-w-3xl">{personalDetails.about}</p>
        <h3 className="text-2xl font-bold text-content py-8 lg:max-w-3xl">Software Developer</h3>
        <p className="text-content py-1 lg:max-w-3xl">{personalDetails.firstStack}</p>
        <h3 className="text-2xl font-bold text-content py-8 lg:max-w-3xl">Product Designer(UI/UX)</h3>
        <p className="text-content py-1 lg:max-w-3xl">{personalDetails.secondStack}</p>
